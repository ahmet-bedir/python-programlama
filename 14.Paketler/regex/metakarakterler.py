...
liste = ["özcan", "mehmet", "süleyman", "selim", "kemal", "özkan", "esra", "dündar", "esin", "esma", "özhan", "özlem", "özkan"]
# for l in liste:
...
### . metakarakteri, yeni satır karakteri hariç bütün karakterleri temsil etmek için kullanılır. “.” metakarakteri sadece tek bir karakterin yerini tutuyor.
for l in liste:
